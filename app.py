...
try:
    ...
    try:
        from youtube_transcript_api import TranscriptsDisabled as _TD, NoTranscriptFound as _NTF, VideoUnavailable as _VU
        TranscriptsDisabled, NoTranscriptFound, VideoUnavailable = _TD, _NTF, _VU
    except Exception:
        pass
